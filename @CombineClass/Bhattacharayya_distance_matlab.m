%http://www.mathworks.com/matlabcentral/fileexchange/18662-bhattacharyya-distance-measure-for-pattern-recognition/content/bhattacharyya.m
...
%The BDM is widely used in Pattern Recognition as a criterion for Feature Selection.
%Directly calculation may result in divide by zero error due to possible (near) singularity of cov(X1)*cov(X2). 
%The improved code uses the Cholesky factorization for the normal cases but uses sqrtm for near singular cases.

function d = Bhattacharayya_distance_matlab(cObj,X1,X2)
