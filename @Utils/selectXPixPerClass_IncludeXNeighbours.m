function selectXPixPerClass_IncludeXNeighbours(obj,nObj)
...
for i =1: obj.numClasses
    ...
    if(obj.numNeigh > 0) 
        ...
        nObj.neighboursData{i} = obj.normalizeToUnitVector(nObj.neighboursData{i});
    end
end
obj.testLabels = testLabels;
...
function selectXPixPerClass_IncludeXNeighboursNonNorm(obj,nObj)
% input: indian_pines,indian_pines_gt,numBands, numPix, numNeigh, numClasses
