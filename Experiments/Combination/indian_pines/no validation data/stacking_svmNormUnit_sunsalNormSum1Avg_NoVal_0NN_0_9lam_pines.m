function stacking_svmNormUnit_sunsalNormSum1Avg_NoVal_0NN_0_9lam_pines
    avgUnmixing = 0;
    iter = 100;
    for a = 1:iter
        ...
        cObj = CombineClass;
        cObj.combineMethodsSVMUnitNormedSunalSum1AvgNoValidation(obj,nObj,svmObj,sunObj);
        ...
        acc = metaSvmObj.svmMetaTest_ProbUnitNormed_AbunSum1Avg(obj,sunObj,cObj);
        avgUnmixing = avgUnmixing + acc;
        fileName = fullfile('Experiments','Combination','indian_pines','results','text','stacking_svmNormUnit_sunsalNormSum1Avg_NoVal_0NN_0_9lam.txt');
