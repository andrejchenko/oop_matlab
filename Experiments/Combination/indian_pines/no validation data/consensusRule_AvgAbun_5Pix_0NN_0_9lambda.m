function consensusRule_AvgAbun_5Pix_0NN_0_9lambda
    ...
    for w = 0:0.1:1
        for a = 1:iter
            ...
            cObj = CombineClass;
            cObj.consensusRuleAvgAbun(obj,nObj,svmObj,sunObj,w);

            EVAL_APHA = obj.calcXAccuracy(obj.testLabels,cObj.labels);
            acc = EVAL_APHA(1)*100;

            avgUnmixing = avgUnmixing + acc;
            fileName = fullfile('Experiments','Combination','indian_pines','results','text','consensusRuleAvgAbun_5Pix_0NN_0_9lambda_w.txt');
