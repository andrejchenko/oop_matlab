function combMaxNormedAbun_Posterior_5Pix_0NN_0_9_lambda
    ...
    for a = 1:iter
        ...
        cObj = CombineClass;
        cObj.select_max_Abun_Posterior(obj,nObj,svmObj,sunObj);

        EVAL_APHA = obj.calcXAccuracy(obj.testLabels,cObj.labels);
        acc = EVAL_APHA(1)*100;
        
        avgUnmixing = avgUnmixing + acc;
        fileName = fullfile('Experiments','Combination','indian_pines','results','text','combMaxNormedAbun_Posterior_5Pix_0NN_0_9lambda1.txt');
