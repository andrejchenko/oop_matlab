function stacking_WithValSet_svm_sunsal_sum1_avg_0NN_pines
 avgUnmixing = [];
    iter = 100;
    for a = 1:iter
        ...
        cObj = CombineClass;
        cObj.combineMethodsWithValDataAvg(obj,nObj,svmObj,sunObj);
        ...
        acc = metaSvmObj.svmMetaTestOnTestExtendedSetAvg(obj,sunObj,cObj);
        avgUnmixing = [avgUnmixing; acc]; 
    end
    avgUnmixing = mean(avgUnmixing);
    save avgAcc_avg avgUnmixing;
end
