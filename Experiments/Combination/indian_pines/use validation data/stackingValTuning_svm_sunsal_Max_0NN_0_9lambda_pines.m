...
avgUnmixing = 0;
    ...
    for a = 1:iter
        ...
        cObj.combineMethodsSVMSunal(obj,nObj,svmObj,sunObj);
        ...
        acc = metaSvmObj.svmMetaTestOnProbWithExtendedSet(obj,sunObj,cObj);
        
        avgUnmixing = avgUnmixing + acc;
        fileName = fullfile('Experiments','Combination','indian_pines','results','text','stacking_svm_sunsal_MAX_5Pix_0NN_0_9lambda.txt');
    ...
    fileName = fullfile('Experiments','Combination','indian_pines','results','text','stacking_svm_sunsal_NoValidation_5Pix_0NN_0_9lambda.txt');
    fileID = fopen(fileName,'a');
